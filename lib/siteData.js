...
export const serviceGroups = [
  ...
  },
  {
    ...
    image: images.tools,
    services: [
      ["Manicure Treatment", 60, "Clean hand care and grooming for a complete look."],
      ["Pedicure Treatment", 70, "Foot care service with a fresh salon finish."],
      ["Foot Spa", 60, "Relaxing foot spa add-on for tired feet."],
...
export const reviews = [
  ["Ahmed R.", "Clean fades, fast service, and the staff understand modern styles."],
  ["Khalid M.", "Premium feel without overpaying. Beard shaping was very sharp."],
  ["Faisal A.", "Great location in Al Warqa and easy to book. My regular salon now."]
];
